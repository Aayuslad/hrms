    ...
    <div style={{ width: '100%', overflowX: 'auto', paddingBottom: 8 }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minWidth: 0 }}>
        ...
        {tree.children && tree.children.length > 0 && (
          <div style={{ display: 'flex', flexDirection: 'row', marginTop: 24, position: 'relative', minWidth: 0, justifyContent: 'center' }}>
            ...
            {tree.children.length > 1 && (
              <div
                style={{
                  position: 'absolute',
                  top: -16,
                  left: 'calc(50% / ' + tree.children.length + ')',
            ...
            {tree.children.map((child: ChartNode, idx: number) => {
              ...
              return (
                <div key={key} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 24px', position: 'relative', minWidth: 0 }}>
