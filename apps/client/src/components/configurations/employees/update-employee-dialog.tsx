      ...
      <DialogContent className="sm:max-w-lg max-h-[85vh] flex flex-col p-0">
        ...
        >
          ...
          <DialogHeader className="px-6 pt-6">
            ...
            <DialogDescription>
              Update the employee profile details and click Save.
            </DialogDescription>
          </DialogHeader>
          ...
          <ScrollArea className="flex-1 px-6 py-4">
            <div className="grid gap-4 pr-4">
              ...
              <div className="grid gap-2">
                ...
                <Input {...form.register('profile.middleName')} />
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Input {...form.register('profile.contactNumber')} />
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={form.watch('profile.departmentId') || ''}
                  onValueChange={(value) =>
                    form.setValue('profile.departmentId', value)
                  }
                >
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={form.watch('profile.designationId') || ''}
                  onValueChange={(value) =>
                    form.setValue('profile.designationId', value)
                  }
                >
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                <Label>Manager</Label>
                <Select
                  value={form.watch('profile.managerId') || ''}
                  onValueChange={(value) =>
                    form.setValue('profile.managerId', value)
                  }
                >
                  <SelectTrigger>
